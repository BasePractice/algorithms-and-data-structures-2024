...
public abstract class BookTest {
    public static void main(String[] args) {
        final Book b = new Book("Washington", "life's enjoy", 1999);
        final Book b1 = new Book("Unknown", "be patient", 1235);
        final Book b2 = new Book("asdf", "k3ep it cool", 1987);
        final Book b3 = new Book("Thomas", "dude", 1945);
