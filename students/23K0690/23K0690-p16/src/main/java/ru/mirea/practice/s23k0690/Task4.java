...
public abstract class Task4 {
    public static void main(String[] args) {
        ...
        JTextField serviceInput = new JTextField(10);
        ...
        ServiceUser userAccount = new ServiceUser("MIREA", "Sergey", "HFTFBEST");
        ...
        verifyButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                int score = 0;
                if (serviceInput.getText().equals(userAccount.getServiceName())) {
                    score++;
                }
                ...
                if (score == 3) {
                    feedbackLabel.setText("Добро пожаловать обратно в " + userAccount.getServiceName() + ", " + userAccount.getUser() + "!");
                } else {
                    feedbackLabel.setText("Неправильные данные, проверите их правильность или попробуйте войти позже");
                }
            }
        });
