...
public final class Manager {
    ...
    public static void main(String[] args) {
        try (Scanner scanner = new Scanner(System.in)) {
            ...
            int money = 0;
            if (product == 1) {
                System.out.println("Вы выбрали товар 1." + product1.getName() + " - Вам надо заплатить" + rise1 + " " + currency + "\nНапишите число сколько денег вы внесли:");
                money = scanner.nextInt();
                money(rise1, money);

            }
            if (product == 2) {
                System.out.println("Вы выбрали товар 2." + product2.getName() + " - Вам надо заплатить" + rise2 + " " + currency + "\nНапишите число сколько денег вы внесли:");
                money = scanner.nextInt();
                money(rise2, money);

            }
            if (product == 3) {
                System.out.println("Вы выбрали товар 3." + product3.getName() + " - Вам надо заплатить" + rise3 + " " + currency + "\nНапишите число сколько денег вы внесли:");
                money = scanner.nextInt();
                money(rise3, money);

            }
            if (product == 4) {
                System.out.println("Вы выбрали товар 4." + product3.getName() + " - Вам надо заплатить" + rise4 + " " + currency + "\nНапишите число сколько денег вы внесли:");
                money = scanner.nextInt();
                money(rise4, money);
    ...
    public static void money(double rise, int money) {
        try (Scanner scanner = new Scanner(System.in)) {
            ...
            if (money < rise) {
                int flag = 0;
                dif = (int) rise - money;
                System.out.print("У вас не хаватает " + dif);
                System.out.print("Внести ещё? ( Ответ: Да - напишите 1, Нет - напишите - 0 " + dif);
