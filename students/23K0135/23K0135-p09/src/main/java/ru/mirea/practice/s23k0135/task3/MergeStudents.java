...
//import ru.mirea.practice.s23k0135.task2.*;

import ru.mirea.practice.s23k0135.task2.CompSciComparator;
import ru.mirea.practice.s23k0135.task2.MathComparator;
import ru.mirea.practice.s23k0135.task2.PhysComparator;
import ru.mirea.practice.s23k0135.task2.PhylosophyComparator;
import ru.mirea.practice.s23k0135.task2.Student;
...
public abstract class MergeStudents {
    ...
    public static void main(String[] args) {
        final Comparator<Student> comparator = new MathComparator()
            .thenComparing(new PhysComparator().thenComparing(new CompSciComparator()
