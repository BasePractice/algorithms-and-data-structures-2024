...
public abstract class RandomArrayUtil {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("nОтсортированный массив, полученный с помощью Math.random():");
        System.out.println(Arrays.toString(randomArray1));
        System.out.println("nОтсортированный массив, полученный с использованием Random:");
        System.out.println(Arrays.toString(randomArray2));
    }
}