...
abstract class Huffman {
    ...
    public static void encode(Node2 root, String str,
    ...
    public static int decode(Node2 root, int index, StringBuilder sb) {
        if (root == null) {
            return index;
        }
        // Найден листовой узел
    ...
    public static void buildHuffmanTree(String text) {
        ...
        for (Map.Entry<Character, Integer> entry : freq.entrySet()) {
            pq.add(new Node2(entry.getKey(), entry.getValue()));
        }
        ...
        while (pq.size() != 1) {
            ...
            pq.add(new Node2('\0', sum, left, right));
        }
