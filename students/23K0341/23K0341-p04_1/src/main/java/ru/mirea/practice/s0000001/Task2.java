...
public class Task_2 {
    public static void main(String[] args) {
        ...
        for (int row = 0, i = 0; row < matrixA.n; row++)
            for (int col = 0; col < matrixA.m; col++, i++)
        ...
        for (int row = 0, k = 0; row < matrixC.n; row++)
            for (int col = 0; col < matrixC.m; col++, k++)
...
class Matrix {
    ...
    public Matrix add(Matrix other) {
        ...
        for (int row = 0, i = 0; row < res.n; row++)
            for (int col = 0; col < res.m; col++, i++)
